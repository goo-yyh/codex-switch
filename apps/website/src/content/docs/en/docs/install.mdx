...
[v0.3.0](https://github.com/goo-yyh/codex-switch/releases/tag/v0.3.0) was published on September 20, 2026. Choose your platform below; Codex Switch download links point to the v0.3.0 installers.
...
Codex Switch installers are served directly by this site’s Vercel CDN, without redirecting to GitHub. Download the [SHA-256 checksums](/downloads/v0.3.0/SHA256SUMS.txt) to verify file integrity.
