...
[v0.1.0](https://github.com/goo-yyh/codex-switch/releases/tag/v0.1.0) was published on September 18, 2026. Choose your platform below; Codex Switch downloads always point to the latest stable release.
...
Download [SHA256SUMS.txt](https://github.com/goo-yyh/codex-switch/releases/latest/download/SHA256SUMS.txt) from the same release as your installer and compare the matching filename’s hash:

```sh
# macOS: replace the filename for an Intel Mac
...
> These Codex Switch installers are not publisher-signed, and the macOS apps are not notarized by Apple. Gatekeeper or SmartScreen may warn or block installation. Verify the source and checksum first; managed devices may prohibit installation.
